...
class DemoBootstrapResult:
    ...
    integrations: Wave10IntegrationResult
...
def build_real_demo_database(
    *,
    ...
    This is intentionally a local/private bootstrap path. It runs the same owner-wave services used
    by the application instead of inserting precomputed scores or hard-coded API answers. A
    deployment-safe derivative snapshot can be created from this database by the Wave 17 seed
