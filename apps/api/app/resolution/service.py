...
from app.resolution.types import ProjectAccountResolutionResult
from app.scoring.config import load_yaml_config


class ProjectAccountResolutionService:
    """Orchestrates project clustering, account intelligence and source entity resolution."""
    ...
    def run(self, *, company_external_id: str = "1000647848") -> ProjectAccountResolutionResult:
        ...
        self.session.commit()
        return ProjectAccountResolutionResult(
