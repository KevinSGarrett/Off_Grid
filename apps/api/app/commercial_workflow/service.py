...
class Wave09CommercialWorkflowService:
    """Create truthful linked contractor/channel motions and dependency-aware actions.

    The service consumes Wave 6-8 state. It does not discover a new counterparty, send outreach,
    ...
    def run(self, *, project_external_id: str = "1007341663") -> Wave09CommercialWorkflowResult:
        ...
        if assessment is None:
            raise ValueError("Wave 09 requires a current persisted opportunity assessment")
        ...
        if source_gc is None:
            raise ValueError("Wave 09 requires a source-backed Stafford general contractor relationship")
        ...
        rental_motion = self._upsert_motion(
            ...
            summary=(
                "Rental-house/channel motion is intentionally unresolved. No supplied or Wave 08 evidence "
        ...
        self.session.commit()
        return Wave09CommercialWorkflowResult(
            ...
            notes=(
                ...
                "Wave 09 records no fabricated calls, demos, rental providers, commercial outcomes, outreach, or CRM writes.",
            ),
        )
    ...
    def _outcome_feedback(self, project_id: UUID) -> OutcomeFeedbackModel:
        ...
        return OutcomeFeedbackModel(
            ...
            notes=(
                "Wave 09 creates structured feedback capture but records no fabricated activity.",
    ...
    def _contractor_result(
        ...
        fields = (
            ...
            MotionFieldState("equipment_arrangement", "UNKNOWN", VerificationState.UNKNOWN, "Current equipment/incumbent arrangement is not in supplied or Wave 08 evidence."),
    ...
    def _rental_result(
        ...
        fields = (
            MotionFieldState("rental_provider", "UNRESOLVED", VerificationState.UNKNOWN, "No Stafford rental provider is established by the supplied PDFs or bounded Wave 08 research."),
