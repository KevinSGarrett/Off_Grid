...
class Wave08ContactResolutionService:
    ...
    def run(self, *, project_external_id: str = "1007341663") -> Wave08ContactResolutionResult:
        ...
        self.session.commit()
        return Wave08ContactResolutionResult(
    ...
    def _ensure_verification_event(
        ...
        *,
        ...
        row = VerificationEvent(
            ...
            note="Wave 08 bounded public research snapshot; no prospect outreach performed.",
            verified_by="wave08_public_research",
    ...
    def _apollo_preview(self, rows: list[ContactCandidateResult]) -> ApolloPreviewPlan:
        ...
        return ApolloPreviewPlan(
            ...
            notes=(
                "No Apollo network call was executed in Wave 08.",
